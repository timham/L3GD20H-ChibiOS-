...
#define L3GD20_SPI_SCK_GPIO_CLK          	RCC_AHBENR_GPIOAEN
#define L3GD20_SPI_SCK_SOURCE            	GPIOA_SPI1_SCK 	  //GPIO_PinSource5
#define L3GD20_SPI_SCK_AF                        ((uint8_t)0x05)

#define L3GD20_SPI_MISO_PIN                    ((uint16_t)0x0040) 	  // GPIO_Pin_6        /* PA.6 */
#define L3GD20_SPI_MISO_GPIO_PORT        GPIOA                    /* GPIOA */
#define L3GD20_SPI_MISO_GPIO_CLK           RCC_AHBENR_GPIOAEN
#define L3GD20_SPI_MISO_SOURCE              GPIOA_SPI1_MISO   	  //GPIO_PinSource6
#define L3GD20_SPI_MISO_AF                      ((uint8_t)0x05)

#define L3GD20_SPI_MOSI_PIN                     ((uint16_t)0x0080) 	  // GPIO_Pin_7        /* PA.7 */
#define L3GD20_SPI_MOSI_GPIO_PORT        GPIOA                    /* GPIOA */
#define L3GD20_SPI_MOSI_GPIO_CLK           RCC_AHBENR_GPIOAEN  	  //RCC_AHBPeriph_GPIOA
...
#define L3GD20_SPI_INT1_PIN                     ((uint16_t)0x0001)       /* PE.00 */
#define L3GD20_SPI_INT1_GPIO_PORT        GPIOE                    /* GPIOE */
#define L3GD20_SPI_INT1_GPIO_CLK           RCC_AHBENR_GPIOEEN
#define L3GD20_SPI_INT1_EXTI_LINE          GPIOE_L3GD20_INT1 //EXTI_Line0
#define L3GD20_SPI_INT1_EXTI_PORT_SOURCE                EXTI_PortSourceGPIOE  	  // 0x04
#define L3GD20_SPI_INT1_EXTI_PIN_SOURCE                  EXTI_PinSource0    	  // 0x00
#define L3GD20_SPI_INT1_EXTI_IRQn                               6 //EXTI0_IRQn    	  // ?  : thsam ???????

#define L3GD20_SPI_INT2_PIN                                      ((uint16_t)0x0002)       /* PE.01 */
#define L3GD20_SPI_INT2_GPIO_PORT                         GPIOE                    /* GPIOE */
#define L3GD20_SPI_INT2_GPIO_CLK                            RCC_AHBENR_GPIOEEN 	  //RCC_AHBPeriph_GPIOE
#define L3GD20_SPI_INT2_EXTI_LINE                           GPIOE_L3GD20_INT2 	  //EXTI_Line1
#define L3GD20_SPI_INT2_EXTI_PORT_SOURCE            EXTI_PortSourceGPIOE
#define L3GD20_SPI_INT2_EXTI_PIN_SOURCE              EXTI_PinSource1
#define L3GD20_SPI_INT2_EXTI_IRQn                          6 			  //EXTI1_IRQn   // ? : thsam ???????
...
#define L3GD20_CS_LOW()       pal_lld_clearport(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN) //GPIO_ResetBits(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
#define L3GD20_CS_HIGH()      pal_lld_setport(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)  //GPIO_SetBits(L3GD20_SPI_CS_GPIO_PORT, L3GD20_SPI_CS_PIN)
...
void L3GD20_Init(SPIDriver *spidrv, SPIConfig *lspicfg);
